package com.moing.moingbe.global.aspect;
...
public class DatabaseAspect {
    ...
    @Around("@annotation(com.moing.moingbe.global.aspect.annotation.TransactionalLockAround)")
    ...
    @Before("@annotation(com.moing.moingbe.global.aspect.annotation.TransactionalLock)")
